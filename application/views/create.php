	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				...
				<input type="text" name="name" class="form-control" value="<?php echo set_value("name") ?>"  placeholder="User Name">
				<?php echo form_error("name"); ?>
			</div>
			<div class="form-group">
				<label for="formGroupExampleInput2">User Email</label>
				<input type="email" name="email" class="form-control" value="<?php echo set_value("email") ?>" placeholder="User Email">
